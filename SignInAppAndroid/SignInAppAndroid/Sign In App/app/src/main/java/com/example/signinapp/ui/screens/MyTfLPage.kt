...
fun MyTfLPage(
    ...
    Column(
        ...
        TfLStaffInfoView(label = stringResource(id = R.string.name), value = User.name,"TechTaskName")
        TfLStaffInfoView(label = stringResource(id = R.string.role), value = User.role, "TechTaskRole")
        TfLStaffInfoView(label = stringResource(id = R.string.office), value = User.office, "TechTaskOffice")
